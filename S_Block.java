public class S_Block {
    public class L_Block extends Block{
        ...
        private Position[][] createTiles() {
            ...
            tiles[0] = new Position[] { new Position(0, 1), new Position(0, 2), new Position(1, 0), new Position(1, 1) };
            tiles[1] = new Position[] { new Position(0, 1), new Position(1, 1), new Position(1, 2), new Position(2, 2) };
            tiles[2] = new Position[] { new Position(1, 1), new Position(1, 2), new Position(2, 0), new Position(2, 1) };
            tiles[3] = new Position[] { new Position(0, 0), new Position(1, 0), new Position(1, 1), new Position(2, 1) };
            return tiles;
        }
